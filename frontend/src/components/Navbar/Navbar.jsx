            ...
            <ul className="list-none p-0 m-0 flex flex-col md:flex-row gap-8 md:gap-12 items-center">
              ...
              <Navlink to="/about" className="relative group">
                ...
                <ul className="absolute top-full left-0 bg-custom-gradient rounded-md p-2 hidden group-hover:block md:group-hover:block">
                  <NavInnerLink to="/logo-design">Logo Design</NavInnerLink>
                  <NavInnerLink to="/web-development">Web Development</NavInnerLink>
                  <NavInnerLink to="/photography">Photography</NavInnerLink>
                  <NavInnerLink to="/content-creator">Content Creator</NavInnerLink>
                  <NavInnerLink to="/video-animation">Video and Animation</NavInnerLink>
                </ul>
              </Navlink>
              <Navlink to="/about">What's New</Navlink>
