    ...
    <>
      <div className="flex flex-col md:flex-row items-start ">
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          <div className="mt-6 md:mt-8 flex justify-center md:justify-end">
              <Button to="pre-signup" className="bg-blue-400 text-white rounded-lg hover:bg-blue-600">
                Create Account
              </Button>
            </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center bg-blue-50 rounded-lg p-16 shadow-2xl w-11/12 lg:w-9/12 mx-auto my-28">
        <div className="bg-white p-6 rounded-lg shadow-md mb-4 lg:mb-0 lg:mr-4 flex-grow">
          <p className="text-lg font-semibold mb-4 flex items-center">
            ...
            <Button  to='/pre-signup' className="bg-teal-600 text-white border border-slate-700">
              Register Now
            </Button>
        </div>
      ...
      <div className="container mx-auto flex flex-wrap lg-md:5 md:gap-3 gap-1 justify-center ">
        <div className="w-[282px] p-1 flex flex-col gap-1 mt-10">
          <HomeFeatureImage src={images[0]} alt="Image 1" />
          <HomeFeatureImage src={images[1]} alt="Image 2" />
          <HomeFeatureImage src={images[2]} alt="Image 3" />
          <HomeFeatureImage src={images[3]} alt="Image 4" />
          <HomeFeatureImage src={images[7]} alt="Image 8" />
        </div>
        <div className="w-[282px] p-1 flex flex-col gap-1 mt-10">
          {" "}
          {/* Adjust padding and gap */}
          <HomeFeatureImage src={images[4]} alt="Image 5" />
          <HomeFeatureImage src={images[5]} alt="Image 6" />
          <HomeFeatureImage src={images[6]} alt="Image 7" />
          <HomeFeatureImage src={images[19]} alt="Image 4" />
        </div>
        <div className="w-[282px] p-1 flex flex-col gap-1 mt-10">
          {" "}
          <HomeFeatureImage src={images[8]} alt="Image 9" />
          <HomeFeatureImage src={images[9]} alt="Image 10" />
          <HomeFeatureImage src={images[10]} alt="Image 11" />
          <HomeFeatureImage src={images[11]} alt="Image 12" />
          <HomeFeatureImage src={images[17]} alt="Image 4" />
        </div>
        <div className="w-[282px] p-1 flex flex-col gap-1 mt-10">
          <HomeFeatureImage src={images[12]} alt="Image 13" />
          <HomeFeatureImage src={images[13]} alt="Image 14" />
          <HomeFeatureImage src={images[14]} alt="Image 15" />
          <HomeFeatureImage src={images[15]} alt="Image 16" />
          <HomeFeatureImage src={images[18]} alt="Image 4" />
        </div>
      </div>
    </>
  );
